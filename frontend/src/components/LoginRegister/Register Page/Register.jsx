...
function Register() {
  return (
    <>
      ...
      <input type="password" placeholder="Password" className="box-1" />
      <input type="text" placeholder="Phone or E-mail" className="box-2" />
      <input type="password" placeholder="Confirm Password" className="box-3" />
